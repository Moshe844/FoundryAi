        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[11px] font-bold transition ${
              active ? "border-foundry-teal/45 bg-foundry-teal/[0.14] text-foundry-ink" : "border-white/10 bg-white/[0.03] text-foundry-subtle hover:border-foundry-teal/25 hover:text-foundry-ink"
            }`}
          >
