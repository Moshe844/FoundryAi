...
import type { FactoryCommandEvent, FactoryEngineeringReport, FactoryExecutionEvent, FactoryLifecyclePhase, FactoryModelUsageEntry, FactoryObjectiveChecklistItem } from "@/lib/factory/types";
...
export type ExecutionMission = {
  ...
  /** Provider-reported tokens priced with Foundry's configured model rates for this mission. */
  model_usage?: FactoryModelUsageEntry[];
