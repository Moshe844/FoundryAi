...
export type PlatformValidationResult = { available: boolean; verified?: boolean; repairEligible?: boolean; failureKind?: string; reason?: string; crashEvidence?: string; action?: string; exitCode?: number | null; stdout?: string; stderr?: string; durationMs?: number; screenshotPath?: string; pid?: number; running?: boolean; interactionVerified?: boolean; steps?: Array<{ action: string; target?: string; matchedName?: string; ok: boolean; invoked?: boolean; invocationMethod?: string; failureKind?: string; reason?: string; candidates?: string[] }>; windowTitles?: string[] };
